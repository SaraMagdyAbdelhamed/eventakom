            ...
            <nav class="navbar navbar-fixed-top   bshadow--0 bradius--noborder " id="sidebar-wrapper" role="navigation">
              ...
              <div class="side">
                <ul class="side-menu">
                  ...
                  <li class="side__list"> <a class="side__item side__item--sub">Users</a>
                    <ul class="side__submenu">
                      <li class="side__sublist"><a class="side__subitem" href="users_mobile_application_users.html">Mobile application users</a></li>
