...
<script type="text/javascript">
    ...
    <script type="text/javascript">
      $('.add-more-branch').on('click' , function(){
       ...
       $('.branch-container:last').after(" <div class='branch-container'>	<div class='col-sm-6 col-xs-12'><div class='master_field'><label class='master_label' for='branch_"+nextCount+"'>branch"+nextCount+" name</label><input class='master_input' type='text' placeholder='branch "+nextCount+" name' Required id='branch_"+nextCount+"'><span class='master_message color--fadegreen'>validation message for "+nextCount+" will be here</span></div></div><div class='col-sm-3 col-xs-6'><div class='master_field'><label class='master_label' for='start_time_"+nextCount+"'>start date time for branch "+nextCount+"</label><div class='bootstrap-timepicker'><input class='timepicker master_input' type='text' placeholder='start time for "+nextCount+"' Required id='start_time_"+nextCount+"'></div><span class='master_message inherit'>message content</span></div></div><div class='col-sm-3 col-xs-6'><div class='master_field'><label class='master_label' for='end_time_"+nextCount+"'>end date time for "+nextCount+"</label><div class='bootstrap-timepicker'><input class='timepicker master_input' type='text' placeholder='end time for "+nextCount+"' Required id='end_time_"+nextCount+"'></div><span class='master_message inherit'>message content</span></div></div></div> ");
