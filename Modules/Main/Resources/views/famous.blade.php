          ...
          <div class="col-xs-12">
            <div class="text-xs-center">         
              <div class="text-wraper">
                ...
                <h4 class="cover-inside-title sub-lvl-2">@lang('keywords.famous')</h4>
              </div>
            </div>
          </div>
                  ...
                  <ul class="tab__content">
                    <li class="tab__content_item active" id="arabic1-content">
                      <div class="master_field">
                        ...
                        <input name="arabicContent"class="master_input" type="text" placeholder="تعديل تصنيف" Required id="edit_id_ar" >
                      </div>
                    </li>
          ...
          $('#sub_1_6').addClass('pure-active');
            ...
            $('#deleteSelected').click(function(){
                ...
                function(isConfirm){
                    ...
                    $.ajax(
                    {
                        url: "{{ route('famous.deleteSelected') }}",
                        type: 'POST',
                        dataType: "JSON",
                        data: {
                            "ids": ids,
