...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="row">
            ...
            <div class="cover--actions"><a class="bradius--no border-btn master-btn" type="button" href="#popupModal_1">@lang('keywords.EditAbout')</a>
            </div>
        </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="col-xs-12">
            <form action="{{ route('about.edit', ['id' => 1]) }}" method="POST">
                ...
                <div class="col-xs-12">
                <button class="remodal-cancel" data-remodal-action="cancel">Salma omar </button>
