          ...
          <div class="col-xs-12">
            <div class="text-xs-center">         
              <div class="text-wraper">
                ...
                <h4 class="cover-inside-title sub-lvl-2">@lang('keywords.terms') </h4>
              </div>
            </div>
          </div>
        ...
        <div class="col-xs-12">
          <form action="{{ route('terms.edit', ['id' => 2]) }}" method="POST">
            ...
            <div class="tabs--wrapper">
                ...
                <li id="english_inpopups" class="{{ App::isLocale('ar') ? 'active' : '' }}">English</li>
                </ul>
                <ul class="tab__content">
