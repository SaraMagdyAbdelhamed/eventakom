                  ...
                  <select class="master_input" id="Currency" name="currency">
                    ...
                    @if ( isset($currencies) && !empty($currencies) )
                        @foreach ($currencies as $currency)
                            <option value="{{ $currency->id }}" @if(isset($event_tickets->price) && !empty($event_tickets->price) && $event_tickets->currency_id == $currency->id) selected @endif>{{\App::isLocale('en') ?$currency->symbol:$currency->arabic('symbol',$currency->id)?$currency->arabic('symbol',$currency->id):$currency->symbol}}</option>
                        @endforeach
                    @endif
                  </select>
